...
while ($row = $results->fetch_assoc()) {
    $csv_row = [
        ...
        formatCurrencyPlain($row['cantik_po_value']),
        formatCurrencyPlain($row['remaining_bal_in_po']),
        $row['vendor_invoice_frequency'],
        $row['vendor_inv_number'],
        formatDateForCSV($row['vendor_inv_date']),
        formatCurrencyPlain($row['vendor_inv_value']),
        formatCurrencyPlain($row['tds_ded']),
        formatCurrencyPlain($row['net_payble']),
        $row['payment_status_from_ntt'],
        formatCurrencyPlain($row['payment_value']),
        formatDateForCSV($row['payment_date']),
        formatCurrencyPlain($row['pending_payment']),
