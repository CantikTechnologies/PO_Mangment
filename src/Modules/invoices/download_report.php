...
while ($row = $results->fetch_assoc()) {
    $csv_row = [
        ...
        $row['cost_center'],
        $row['customer_po'],
        formatCurrencyPlain($row['remaining_balance_in_po']),
        $row['cantik_invoice_no'],
        formatDateForCSV($row['cantik_invoice_date']),
        formatCurrencyPlain($row['cantik_inv_value_taxable']),
        formatCurrencyPlain($row['tds']),
        formatCurrencyPlain($row['receivable']),
